...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pageLabelGenerator = __webpack_require__(191);
	
	var _pageLabelGenerator2 = _interopRequireDefault(_pageLabelGenerator);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var _marked = [times].map(regeneratorRuntime.mark);
	
	function times(n) {
	  var i;
	  return regeneratorRuntime.wrap(function times$(_context) {
	...
	var gen = _pageLabelGenerator2.default.pageLabelGenerator();
	...
	try {
	  for (var _iterator = times(5)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    var i = _step.value;
